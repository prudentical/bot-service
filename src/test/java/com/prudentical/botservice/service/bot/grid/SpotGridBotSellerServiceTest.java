...
public class SpotGridBotSellerServiceTest {
    ...
    private SpotGridSellerService service;

    @BeforeEach
    void beforeEach() {
        service = new SpotGridSellerServiceImpl(exchange, grider, price);
    }
    ...
    void sell_whenPriceGoesToHigherGrid_shouldPlaceOrder() {
        ...
        var result = service.tryToSell(context);
